...
//   { id: "c-1", category: "MILLET IDLY RAVVAS", image: "https://source.unsplash.com/featured/600x600/?millet,idli", productCount: 5, createdAt: "2025-09-01" },
//   { id: "c-2", category: "MILLET UPMA RAVVA", image: "https://source.unsplash.com/featured/600x600/?millet,upma", productCount: 4, createdAt: "2025-09-02" },
//   { id: "c-3", category: "GRAINS", image: "https://source.unsplash.com/featured/600x600/?grains,cereal", productCount: 5, createdAt: "2025-09-03" },
//   { id: "c-4", category: "SPECIAL DRY FRUITS", image: "https://source.unsplash.com/featured/600x600/?dry-fruits,nuts", productCount: 6, createdAt: "2025-09-04" },
//   { id: "c-5", category: "FLOUR", image: "https://source.unsplash.com/featured/600x600/?flour,wheat", productCount: 5, createdAt: "2025-09-05" },
// ];
...
//           <button onClick={openCreate} className="flex items-center gap-2 px-4 py-2 rounded-md bg-emerald-600 text-white hover:bg-emerald-700 shadow" title="Add Category">
...
//                     <p className="text-xs text-slate-400 mt-2">Max 5MB. Square images work best. (Raw file is uploaded.)</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
          ...
          <div className="flex flex-wrap gap-8">
            {categories.map((c) => (
              <div key={String(c.id)} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 flex flex-col items-center text-center">
                ...
                <div className="mt-4 px-2 w-full">
                  <div className="text-green-800 font-semibold text-lg leading-tight">{c.category}</div>
                  <div className="text-sm text-slate-500 mt-1">{(typeof c.products_count === "number" ? c.products_count : 0) + " Products"}</div>
